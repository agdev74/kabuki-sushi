...
export default function AdminHeader({ lang }: { lang: string }) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-neutral-800 bg-[#080808]">
      <div className="container mx-auto px-4 md:px-6 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-[10px] font-bold text-gray-500 hover:text-white hover:bg-red-600/10 border border-transparent hover:border-red-600/20 transition-all uppercase tracking-widest group"
          >
